      ...
      <form onSubmit={HandleSubmit} className="w-full max-w-[700px] flex flex-col items-center mt-8">
        <div className="w-full mb-4">
          <input
            ...
            className="w-full px-4 py-2  outline-none rounded-lg border-2 border-[#3c3c3c] text-[#2e2e2e] dark:bg-gray-900 dark:border-white"
          />
        </div>
        <div className="w-full mb-4">
          <input
        ...
        <div className="w-full mb-4">
          <textarea
            ...
            required
            className="w-full px-4 py-4 outline-none h-64 rounded-lg border-2 border-[#3c3c3c] text-[#2e2e2e] dark:bg-gray-900 dark:border-white"
          />
        </div>
